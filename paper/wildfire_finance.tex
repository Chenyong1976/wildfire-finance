...
Control ($N$) &  98 & &  98 & &  98 & \\
\addlinespace
\multicolumn{7}{l}{\footnotesize Row~5 (excl.\ CA): $N_{\rm trt}=194$, $N_{\rm ctl}=93$} \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]
\small
...
to 230$\times$ (extensive) larger effective sample size---equivalently,
7$\times$ (intensive) to 15$\times$ (extensive) smaller standard errors---to
reliably detect effects of that magnitude.
\end{tablenotes}
\end{threeparttable}
\end{table}
